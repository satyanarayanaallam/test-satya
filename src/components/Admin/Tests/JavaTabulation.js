// import react, react-router-dom packages and index.css file to render JavaTabulation component
...
function JavaTest() {
  ...
  // useState of data to store Java test data responses 
  ...
  return (
    ...
    <div className="test-reports-container">
      ...
      <div className='admin-header-container'>
        ...
        {/* desktop table container with table of Java test data respones */}
        ...
        {/* mobile table container with table of Java test data responses */}
