// import react, react-router-dom packages and index.css file to render FreshersTabulation component
...
const FreshersTest = () =>{
  ...
  // useState of data to store Freshers test data responses 
